...
export const metadata: Metadata = {
  title: "Retaining Walls Sydney | Durable & Stylish Retaining Wall Builders | RRR Bricklaying",
  description:
    "RRR Bricklaying provides expert retaining wall construction in Sydney. We build strong, stylish, and long-lasting retaining walls for residential and commercial properties. Get durable, affordable, and custom retaining wall solutions.",
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Retaining Walls Sydney - RRR Bricklaying",
      },
    ],
    type: "website",
  },
